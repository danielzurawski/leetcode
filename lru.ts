...
class DoublyLinkedList {
  private firstNode: ListNode | null;
  private lastNode: ListNode | null;
  ...
  insertAtStart(key: number, val: number): ListNode {
  ...
  deleteMiddle(node: ListNode): void {
...
const debug = (size: number, commands: string[], data: number[][]) => {
